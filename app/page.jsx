...
export default function Home() {
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-evenly p-24 main">
      ...
      <div className='flex flex-row items-center justify-center ml-auto mr-auto h-3'>
            <div>
        ...
        <div className='intro ml-2 text-base flex flex-col items-center justify-center text-center text-red-600 m-28'>
              <h1>
   ...
   <div className='flex flex-col mt-10'> 
          <div className='main2 h-auto w-96 rounded-xl mt-16 p-5 bg-gray-100 md:w-1/2 border-2 border-blue-200 overflow-hidden'>
                <h1 className="text-3xl font-bold mb-5 text-center text_color">ABOUT ME</h1>
                <p className="text-lg text-justify text-wrap">Hello, I&apos;m Manish, a passionate MERN Stack Developer with a knack for crafting dynamic web applications. With a strong foundation in MongoDB, Express.js, React, and Node.js, I bring ideas to life by seamlessly merging front-end and back-end technologies. My commitment to clean code and responsive design ensures that every project I undertake is user-friendly and performs flawlessly. I thrive on solving complex problems and continually expanding my skillset to stay at the forefront of web development trends. Explore my portfolio to see how I can transform your digital vision into reality.</p>
          </div>
          <div className='main2 rounded-xl w-96 mt-16 p-5 bg-gray-100 md:w-1/2 mr-3 ml-auto border-2 border-blue-300'>
              ...
              <div className='main2 rounded-xl w-96 mt-16 p-5 md:w-1/2 border-2 border-blue-400'>
