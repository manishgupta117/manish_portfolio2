...
export default function Home() {
  return (
   ...
   <div className='flex text-white flex-col mt-10'> 
          <div className='main2 h-auto text-white w-100 rounded-xl mt-16 p-5 bg-gray-100 md:w-1/2 border-2 border-blue-200 overflow-hidden'>
          ...
          <div className='main2 rounded-xl w-100 mt-16 p-5 bg-gray-100 md:w-1/2 mr-3 ml-auto border-2 border-blue-300'>
              ...
              <div className='main2 rounded-xl w-100 h-2/4\ mt-16 p-5 md:w-1/2 border-2 border-blue-400'>
          ...
          <div className='main2 rounded-xl mt-16 p-5 w-100 md:w-1/2 border-2 border-blue-500 mr-3 ml-auto'>
